...
public class PelangganManager {
    ...
    private void initializeDefaultPelanggan() {
        daftarPelanggan.add(new Pelanggan("P001", "Budi Santoso", "Surabaya", "A1", true));
        daftarPelanggan.add(new Pelanggan("P002", "Siti Nurhaliza", "Malang", "B2", true));
        daftarPelanggan.add(new Pelanggan("P003", "Ahmad Fauzi", "Sidoarjo", "C3", false));
    }
    ...
    public void tambahPelanggan() {
        ...
        daftarPelanggan.add(new Pelanggan(kode, nama, alamat, nomorMeja, pelangganTetap));
    ...
    public void ubahPelanggan() {
        ...
        Pelanggan pelanggan = cariPelanggan(kode);
        if (pelanggan == null) {
    ...
    public Pelanggan cariPelanggan(String kode) {
        for (Pelanggan pelanggan : daftarPelanggan) {
